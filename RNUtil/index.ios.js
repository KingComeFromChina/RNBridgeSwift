...
// 初始化
    ...
    render() {
        ...
        return (
            ...
            //方法调用 transportMessage要和Swift设定的一样  这样写会跳转{'method:'push', name':'King','url':'http://www.jianshu.com/p/1537bb431d12'}
          RNBridgeModule.transportMessage({'name':'King','url':'http://www.jianshu.com/p/1537bb431d12'});
        }}>
